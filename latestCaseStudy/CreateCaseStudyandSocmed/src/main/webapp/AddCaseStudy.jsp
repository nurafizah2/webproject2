<%@page import="Model.CaseStudy"%>
<%@page import="DAO.CaseStudyDAO"%>
...
<head>
    ...
    <title>Social Media Case Study</title>
    <style>
        /* General styles */
        body {
...
<body>
        ...
        <a href="CaseStudy.jsp"class="active">Case Study Inventory</a>
        <a href="Socmed.jsp" >Social Media Inventory</a>
    ...
    <div class="container">
        <h1>Add Case Study Item</h1>
        <form action="CaseStudyServlet" method="post">
            <table>
                <tr>
